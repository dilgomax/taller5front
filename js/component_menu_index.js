            ...
            <ul class="menu-navegacion">
              ...
              <li class="item-menu item-menu-sub-menu">
                ...
                <ul class="sub-menu" id="sub-menu">
                  <li class="item-menu">
                    <a href="html/punto1.html" class="item-menu-link">Punto 1</a>
                  </li>
                  <li class="item-menu">
                    <a href="html/punto2.html" class="item-menu-link">Punto 2</a>
                  </li>
                  <li class="item-menu">
                    <a href="html/punto3.html" class="item-menu-link">Punto 3</a>
                  </li>
                  <li class="item-menu">
                    <a href="html/punto4.html" class="item-menu-link">Punto 4</a>
                  </li>
                  <li class="item-menu">
                    <a href="html/punto5.html" class="item-menu-link">Punto 5</a>
                  </li>
                  <li class="item-menu">
                    <a href="html/punto6.html" class="item-menu-link">Punto 6</a>
                  </li>
                  <li class="item-menu">
                    <a href="html/punto7y8.html" class="item-menu-link">Punto 7 y 8</a>
                  </li>
                  <li class="item-menu">
                    <a href="html/punto9.html" class="item-menu-link">Punto 9</a>
                  </li>
                  <li class="item-menu">
                    <a href="html/punto10.html" class="item-menu-link">Punto 10</a>
                  </li>
                  <li class="item-menu">
                    <a href="html/punto11.html" class="item-menu-link">Punto 11</a>
                  </li>
                  <li class="item-menu">
                    <a href="html/punto12.html" class="item-menu-link">Punto 12</a>
                  </li>
                </ul>
              </li>
              <li class="item-menu">
